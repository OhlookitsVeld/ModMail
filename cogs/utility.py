...
class Utility(commands.Cog):
    ...
    async def about(self, ctx):
        ...
        embed.add_field(name="Author", value="[`kyb3r`](https://github.com/OhlookitsVeld)")
        ...
        embed.add_field(
            name="GitHub", value="https://github.com/ohlookitsVeld/ModMail", inline=False
        )

        embed.add_field(
            name="Discord Server", value="https://discord.gg/rHRCcyb", inline=False
        )

        embed.add_field(
            name="Donate",
            value="Support this bot on [`Patreon`](https://patreon.com/OhlookitsVeld).",
        )
    ...
    async def sponsors(self, ctx):
        ...
        resp = await self.bot.session.get(
            "https://raw.githubusercontent.com/OhlookitsVeld/ModMail/master/SPONSORS.json"
        )
