"""
Retrieved from matplotlib colors library.
...
TABLEAU_COLORS_NORM = {"tab:" + name: value for name, value in TABLEAU_COLORS.items()}
...
XKCD_COLORS_NORM = {"xkcd:" + name: value for name, value in XKCD_COLORS.items()}
...
# Normalize name to "tab:<name>" to avoid name collisions.
CSS4_COLORS_NORM = {"css:" + name: value for name, value in CSS4_COLORS.items()}

ALL_COLORS = {}
ALL_COLORS.update(BASE_COLORS)
ALL_COLORS.update(CSS4_COLORS)
ALL_COLORS.update(CSS4_COLORS_NORM)
ALL_COLORS.update(XKCD_COLORS)
