...
class Changelog:
    ...
    RAW_CHANGELOG_URL = (
        "https://raw.githubusercontent.com/OhlookitsVeld/ModMail/master/CHANGELOG.md"
    )
    CHANGELOG_URL = "https://github.com/OhlookitsVeld/ModMail/blob/master/CHANGELOG.md"
